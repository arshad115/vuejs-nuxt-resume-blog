<template>
  <nav
    class="flex items-center justify-between flex-wrap bg-red-600 p-4 sticky top-0 z-10"
  >
    <NuxtLink
      v-show="!showNavLinks"
      to="/"
    ...
    <VueNextLevelScroll v-show="showNavLinks">
      <NuxtLink
    ...
    <div v-show="showNavLinks" class="block lg:hidden">
      <button
    ...
    >
      ...
      <div>
        <a
          class="block mt-4 lg:inline-block lg:mt-0 text-red-200 hover:text-white mr-4 no-underline cursor-pointer"
          href="https://arshadmehmood.com/portfolio/"
          rel="noopener"
          target="_blank"
        >
          Blog
